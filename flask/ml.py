...
# client = MongoClient('mongodb+srv://sumukhbhat2701:pass@cluster0.ztp7u.mongodb.net/Mybrary_DB?retryWrites=true&w=majority')
# db = client.Mybrary_DB
# collection = db.books
...
#     topics.append(i[1])
#     topics.append(i[2])
print("From top rec",top_rec)
@app.route('/recommend')
def get_recommend():
    return {'friends':top_rec}